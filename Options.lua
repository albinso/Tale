...
function Tale:OptionsSave()
    ...
    Tale_Options.pvpKillLog = TaleOptions_Options_PvPKillLogCB:GetChecked()
    Tale_Options.pvpKill = TaleOptions_Options_PvPKillCB:GetChecked()
...
function Tale:OptionsRestore()
    ...
    TaleOptions_Options_PvPKillCB:SetChecked(Tale_Options.pvpKill)
    Tale:OptionsEnableDisable(TaleOptions_Options_PvPKillCB)

    TaleOptions_Options_PvPKillLogCB:SetChecked(Tale_Options.pvpKillLog)
